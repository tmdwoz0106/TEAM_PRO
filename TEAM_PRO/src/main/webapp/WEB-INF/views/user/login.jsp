...
<script type="text/javascript" src="/resources/js/user/login.js"></script>
    ...
    <input type="text" id="user_id" class="form-control" placeholder="id" name="user_id" value="" required autofocus>
    <label for="inputPassword" class="sr-only">Password</label>
    <input type="password" id="user_pw" class="form-control" placeholder="Password" name="user_pw" value="" required>
    ...
    <button class="btn btn-lg btn-secondary btn-block" type="button" id="encbtn">로그인</button>
